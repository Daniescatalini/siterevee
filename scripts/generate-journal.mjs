...
${header()}
    <main>
      ...
      <section class="journal-newsletter" id="newsletter" aria-labelledby="newsletter-title">
        ...
        <form class="journal-newsletter-form" name="journal-newsletter" method="POST" data-netlify="true" data-journal-newsletter novalidate>
